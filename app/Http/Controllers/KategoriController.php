...
class KategoriController extends Controller
{
    ...
    {
        $request->validate([
            'kategori_code' => 'required|string|min:3|max:10|unique:m_kategori,kategori_code',
    ...
    {
        $request->validate([
            'kategori_code' => 'required|string|min:3|max:10|unique:m_kategori,kategori_code,' . $id . ',kategori_id',
            'kategori_nama' => 'required|string|max:100'
        ]);
